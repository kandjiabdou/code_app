  ...
  <v-container fluid>
    <v-form ref="form">
      ...
      <v-card class="pa-2 mb-3" outlined>
        ...
        <v-row dense>
          <v-col cols="12" md="3">
            <v-text-field density="compact" v-model="demandeDataForm.nomApplication" label="Nom Application VISTA *" :rules="requiredRules" dense hide-details="auto" rounded variant="outlined"/>
          </v-col>
          <v-col cols="12" md="3">
            <v-text-field density="compact" v-model="demandeDataForm.nomRessourceCloud" label="Nom Ressource Cloud VISTA *" :rules="requiredRules" dense hide-details="auto" rounded variant="outlined"/>
          </v-col>
          <v-col cols="12" md="3">
            <v-text-field v-model="demandeDataForm.nomSousApplication" density="compact" label="Nom sous-application (Optionnel)" persistent-hint :rules="optionalMajusculeRules" dense hide-details="auto" rounded variant="outlined"/>
          </v-col>
          <v-col cols="12" md="3">
            <v-select density="compact" v-model="demandeDataForm.environnement" :items="environnements" label="Environnement *" :rules="requiredRules" dense hide-details="auto" rounded outlined/>
          </v-col>
        </v-row>
      </v-card>
